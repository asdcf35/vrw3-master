  ...
  return (
    <>
      ...
      <h2 style={{ textAlign: "center" }}>
        How we are going to show ourselves
      </h2>
      ...
      <Modal isOpen={modalAZ.isOpen} onOpenChange={modalAZ.onOpenChange}>
        <ModalContent>
          {(onClose) => (
            <>
      ...
      <Modal isOpen={modalNC.isOpen} onOpenChange={modalNC.onOpenChange}>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">
      ...
      <Modal isOpen={modalWI.isOpen} onOpenChange={modalWI.onOpenChange}>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">
      ...
      <Modal isOpen={modalPA.isOpen} onOpenChange={modalPA.onOpenChange}>
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">
